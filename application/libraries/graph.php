...
class graph
{
	...
	*/
	function graph()
	{
		...
		// GRID styles:
		$this->x_axis_colour = '#222222';
		$this->x_axis_3d = '';
		$this->x_grid_colour = '#222222';
		$this->x_axis_steps = 1;
		$this->y_axis_colour = '#222222';
		$this->y_grid_colour = '#222222';
		$this->y2_axis_colour = '#222222';
		...
		$this->lines = array();
		$this->line_default['type'] = 'line,#222222';
		$this->line_default['values'] = '3,#222222';
		$this->js_line_default = 'so.addVariable("line","3,#222222");';
